...
public class Game implements Serializable
{
  ...
  private transient static Comparator<HallOfFameEntry> hallOfFameEntriesPriority;
  ...
  public static boolean setHallOfFameEntriesPriority(Comparator<HallOfFameEntry> aHallOfFameEntriesPriority)
  {
    boolean wasSet = false;
 ...
 for(Game game : games){
  ...
  // line 67 "../../../../../Block223Persistence.ump"
   public static  void reinitializeBlock(List<Game> games){
    for(Game game : games){
  ...
  // line 81 "../../../../../Block223 v3.ump"
   public Block getRandomBlock(){
    Random r = new Random();
        int random = Math.abs(r.nextInt())%numberOfBlocks();
